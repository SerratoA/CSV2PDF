// has no functionality, but for script

const html_to_pdf = require('html-pdf-node');
const fs = require('fs');
const path = require('path');

module.exports = function generatePdfs(filePath, outputDir, customName) {
  const websiteName = "App Tester 102"; // created folder name
