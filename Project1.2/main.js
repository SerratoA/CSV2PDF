...
let convertButtonPressed = false;
...
// ipcMain.on("file-path", (event, filePath, outputDir, customName) => {
//   // Pass the file path to the second JavaScript file
//   require('/Users/chaeilyun/Desktop/Project1 2/Renderer/urlpdf.js')(filePath, outputDir, customName);
// });

// The actual convertor (outputs the pdf)
// ipcMain.on('generate-pdfs', (event, csvFilePath, outputDirectory, folderName) => {
//   generatePdfs(csvFilePath, outputDirectory, folderName);
// });

// ipcMain.on("file-path", (event, filePath, outputDir, customName) => {
//   // Pass the file path to the second JavaScript file only if the convert button has been pressed
